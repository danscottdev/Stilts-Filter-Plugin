<?php
/**
 * Third-party code, was used in prior versions of filter plugin... but not sure if we still need it.
 * Filter Plugin functionality seems to work fine without it being included.
