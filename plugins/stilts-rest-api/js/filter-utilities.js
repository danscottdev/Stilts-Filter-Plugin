const filterUtilities = {
  ...
  convertStateToFullName: function(input) {
    if (input === undefined) return input;
    var strInput = input.trim();
    if (strInput.length !== 2) {
  ...
  getState: function(zipString) {
    // Look up state name for Zipcode
    // src: https://stackoverflow.com/questions/28821804/how-can-i-quickly-determine-the-state-for-a-given-zipcode
